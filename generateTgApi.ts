    ...
    tgMethodDef.fields
      ? [
        ts.factory.createParameterDeclaration(
          ...
          undefined,
          "params",
          // add question token if there aren't any required fields
          tgMethodDef.fields.some((field) => field.required)
            ? undefined
            : ts.factory.createToken(ts.SyntaxKind.QuestionToken),
          // the type is a type reference to a interface generated by generateApiMethodParamNode
